...
open class LineChart: UIView {
    ...
    */
    ...
    fileprivate func drawAreaBeneathLineChart(_ lineIndex: Int) {
        ...
        //UIColor.fRedColor().colorWithAlphaComponent(0.2).setFill()
        // move to origin
...
//        }
    ...
    fileprivate func drawXLabels() {
        ...
        for (index, _) in xAxisData.enumerated() {
            ...
            label.textColor = UIColor.white //MARK:  color for labels
...
extension LineChart {
    // override the color schemee in this extension
    
    public func overrideBaseColorsWith(colorSelected: UIColor) {
        self.colors[0] =  colorSelected
    }
}
